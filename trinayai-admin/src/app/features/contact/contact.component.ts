      ...
      <div class="mx-auto max-w-6xl relative z-10">
        <div class="grid gap-20 lg:grid-cols-2 lg:items-center">
          ...
          <div class="relative group">
            ...
            <p-card class="relative border border-white/5 bg-slate-900/40 backdrop-blur-3xl shadow-3xl p-4">
              <form class="space-y-8">
                ...
                <div class="flex flex-col gap-3">
                  ...
                  <textarea rows="5" pInputTextarea [autoResize]="true" placeholder="How can we help you scale?"
