        ...
        <div class="grid grid-cols-2 gap-8 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
          <a *ngFor="let client of clients"
            ...
            <span *ngIf="!client.imageUrl"
                  class="text-center text-base font-black uppercase tracking-wider text-slate-500 transition-all duration-500 group-hover:text-white group-hover:scale-105">
              {{ client.name }}
            </span>
