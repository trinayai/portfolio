    ...
    <div class="min-h-screen bg-slate-950 px-6 py-32 relative overflow-hidden">
      ...
      <div class="mx-auto max-w-7xl relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[280px]">
          <p-card *ngFor="let item of items; let i = index"
                  [class]="'relative overflow-hidden border border-white/5 bg-slate-900/40 backdrop-blur-3xl transition-all duration-700 hover:border-blue-500/40 hover:bg-slate-800/60 group shadow-2xl ' + (i === 0 ? 'md:col-span-2 md:row-span-2' : i === 3 ? 'md:col-span-2' : '')">
            ...
            <div class="h-full flex flex-col" [ngClass]="{'justify-end pb-8': i === 0}">
              ...
              <ng-template [ngIf]="i !== 0" pTemplate="footer">
