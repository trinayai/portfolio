          ...
          <div class="mx-auto max-w-7xl px-6 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[300px]">
              ...
              <ng-container *ngIf="homeSections[0]">
                <p-card styleClass="md:col-span-2 md:row-span-2 h-full border border-white/10 bg-slate-900/40 transition-all duration-700 hover:bg-slate-800/60 hover:border-cyan-500/50 group overflow-hidden shadow-2xl">
              ...
              <ng-container *ngIf="homeSections[1]">
                <p-card styleClass="md:col-span-1 md:row-span-1 h-full border border-white/10 bg-slate-900/40 transition-all duration-700 hover:bg-slate-800/60 hover:border-fuchsia-500/50 group overflow-hidden">
                  <ng-template pTemplate="header">
                     <div class="pt-8 px-8">
              ...
              <ng-container *ngIf="homeSections[2]">
                <p-card styleClass="md:col-span-1 md:row-span-1 h-full border border-white/10 bg-slate-900/40 transition-all duration-700 hover:bg-slate-800/60 hover:border-blue-500/50 group overflow-hidden">
                  <ng-template pTemplate="header">
                     <div class="pt-8 px-8">
              ...
              <p-card styleClass="md:col-span-2 md:row-span-1 h-full border border-white/10 bg-gradient-to-r from-slate-900/40 to-cyan-950/20 backdrop-blur-xl transition-all duration-700 hover:bg-slate-800/60 hover:border-cyan-500/40 group relative overflow-hidden">
