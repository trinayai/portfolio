      ...
      <div class="mx-auto max-w-7xl relative z-10">
        ...
        <div class="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-3">
          <ng-container *ngFor="let item of services; let i = index">
            <p-card styleClass="h-full border border-white/5 bg-slate-900/40 backdrop-blur-xl transition-all duration-700 hover:-translate-y-3 hover:bg-slate-800/60 hover:border-cyan-500/40 overflow-hidden group shadow-2xl"
